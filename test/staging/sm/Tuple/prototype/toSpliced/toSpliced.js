...
assert.sameValue(method.call(#[1,2,3,4,5,6], 2, 3), #[1,2,6]);
assert.sameValue(method.call(Object(#[1,2,3,4,5,6]),2,3), #[1,2,6]);
...
assert.sameValue(#[1,2,3,4,5].toSpliced(1, 2), #[1,4,5]);

var tup = #[1,2,3];
var len = 3;
/* Step 4 -- toInteger returns 0 for non-integers */
assert.sameValue(tup.toSpliced("monkeys", 2), tup.toSpliced(0, 2));
assert.sameValue(tup.toSpliced(undefined, 2), tup.toSpliced(0, 2));
assert.sameValue(tup.toSpliced(undefined), tup.toSpliced(0, len));
assert.sameValue(tup.toSpliced(), tup.slice(0));

/* Step 5 */
/* relativeStart < 0, len + relativeStart > 0 */
var relativeStart = -1;
var result = tup.toSpliced(relativeStart, 1);
assert.sameValue(result, tup.toSpliced(len + relativeStart, 1));
assert.sameValue(result, #[1,2]);
/* relativeStart < 0, len + relativeStart < 0 */
relativeStart = -4;
result = tup.toSpliced(relativeStart, 1);
assert.sameValue(result, tup.toSpliced(0, 1));
...
relativeStart = 5;
result = tup.toSpliced(relativeStart, 1);
assert.sameValue(result, tup.toSpliced(len, 1));
assert.sameValue(result, tup);
/* relativeStart > 0, relativeStart === len */
relativeStart = len;
result = tup.toSpliced(relativeStart, 1);
assert.sameValue(result, tup);
...
assert.sameValue(result, tup.toSpliced(0, 0));
assert.sameValue(result, tup);

/* Step 7 -- 1 argument */
result = tup.toSpliced(1);
assert.sameValue(result, tup.toSpliced(1, len - 1));
...
assert.sameValue(tup.toSpliced(1, "monkeys"), tup.toSpliced(1, 0));
assert.sameValue(tup.toSpliced(1, undefined), tup.toSpliced(1, 0));
assert.sameValue(tup.toSpliced(1, true), tup.toSpliced(1, 1));
/* (b) deleteCount < 0, len - actualStart > 0 */
result = tup.toSpliced(1, -1);
assert.sameValue(result, tup.toSpliced(1, 0));
assert.sameValue(result, tup);
/* (c) deleteCount < 0, len - actualStart === 0 */
result = tup.toSpliced(3, -1);
assert.sameValue(result, tup.toSpliced(3, 0));
assert.sameValue(result, tup);
/* (d) deleteCount < 0, len - actualStart < 0 */
/* Step 5 guarantees this case can't happen */
/* (e) deleteCount === 0 */
assert.sameValue(tup.toSpliced(1, 0), tup);
/* (f) deleteCount > 0, deleteCount < (len - actualStart) */
var tup2 = #[1,2,3,4,5];
var tup2_len = 5;
result = tup2.toSpliced(1, 3);
assert.sameValue(result, #[1, 5]);
/* (g) deleteCount > 0, deleteCount > (len - actualStart) */
var actualStart = 3;
result = tup2.toSpliced(actualStart, 4);
assert.sameValue(result, tup2.toSpliced(actualStart, tup2_len - actualStart));
assert.sameValue(result, #[1,2,3]);
/* 3 arguments */
assert.sameValue(tup2.toSpliced(1, "bunnies", "monkeys"), tup2.toSpliced(1, 0, "monkeys")); // (a)
assert.sameValue(tup2.toSpliced(1, -1, "monkeys"), tup2.toSpliced(1, 0, "monkeys")); // (b)
assert.sameValue(tup2.toSpliced(tup2_len, -1, "monkeys"), tup2.toSpliced(tup2_len, 0, "monkeys")); // (c)
assert.sameValue(tup2.toSpliced(2, 0, "monkeys"), #[1, 2, "monkeys", 3, 4, 5]); // (e)
assert.sameValue(tup2.toSpliced(1, 3, "monkeys"), #[1, "monkeys", 5]); // (f)
assert.sameValue(tup2.toSpliced(3, 4, "monkeys"), #[1, 2, 3, "monkeys"]); // (g)
/* 4 arguments */
assert.sameValue(tup2.toSpliced(1, "monkeys", 42, 17), tup2.toSpliced(1, 0, 42, 17)); // (a)
assert.sameValue(tup2.toSpliced(1, -1, 42, 17), tup2.toSpliced(1, 0, 42, 17)); // (b)
assert.sameValue(tup2.toSpliced(tup2_len, -1, 42, 17), tup2.toSpliced(tup2_len, 0, 42, 17)); // (c)
assert.sameValue(tup2.toSpliced(2, 0, 42, 17), #[1, 2, 42, 17, 3, 4, 5]); // (e)
assert.sameValue(tup2.toSpliced(1, 3, 42, 17), #[1, 42, 17, 5]); // (f)
assert.sameValue(tup2.toSpliced(3, 4, 42, 17), #[1, 2, 3, 42, 17]); // (g)
...
assert.sameValue(tup.toSpliced(actualStart, actualDeleteCount), #[]);

/* actualStart = 0, itemCount = 1, actualDeleteCount = len */
actualStart = 0;
actualDeleteCount = len;
assert.sameValue(tup.toSpliced(actualStart, actualDeleteCount, "monkeys"), #["monkeys"]);

/* actualStart = 0, itemCount = 4, actualDeleteCount = len */
assert.sameValue(tup.toSpliced(actualStart, actualDeleteCount, "a", "b", "c", "d"), #["a", "b", "c", "d"]);

/* actualStart = 0, itemCount = 0, actualDeleteCount < len */
actualDeleteCount = 3;
assert.sameValue(tup.toSpliced(actualStart, actualDeleteCount), #[4, 5, 6]);

/* actualStart = 0, itemCount = 1, actualDeleteCount < len */
assert.sameValue(tup.toSpliced(actualStart, actualDeleteCount, "monkeys"), #["monkeys", 4, 5, 6]);

/* actualStart = 0, itemCount = 4, actualDeleteCount < len */
assert.sameValue(tup.toSpliced(actualStart, actualDeleteCount, 42, 43, 44, 45), #[42, 43, 44, 45, 4, 5, 6]);

/* actualStart = 1, itemCount = 0, actualDeleteCount = len - 1 */
actualStart = 1;
actualDeleteCount = len - 1;
assert.sameValue(tup.toSpliced(actualStart, actualDeleteCount), #[1]);

/* actualStart = 1, itemCount = 1, actualDeleteCount = len - 1 */
assert.sameValue(tup.toSpliced(actualStart, actualDeleteCount, "monkeys"), #[1, "monkeys"]);

/* actualStart = 1, itemCount = 4, actualDeleteCount = len - 1 */
assert.sameValue(tup.toSpliced(actualStart, actualDeleteCount, 0.0, 0.1, 0.2, 0.3), #[1, 0.0, 0.1, 0.2, 0.3]);

/* actualStart = 1, itemCount = 0, actualDeleteCount < len - 1 */
actualDeleteCount = 1;
assert.sameValue(tup.toSpliced(actualStart, actualDeleteCount), #[1, 3, 4, 5, 6]);

/* actualStart = 1, itemCount = 1, actualDeleteCount < len - 1 */
assert.sameValue(tup.toSpliced(actualStart, actualDeleteCount, "monkeys"), #[1, "monkeys", 3, 4, 5, 6]);

/* actualStart = 1, itemCount = 4, actualDeleteCount < len - 1 */
assert.sameValue(tup.toSpliced(actualStart, actualDeleteCount, 8, 9, 10, 11), #[1, 8, 9, 10, 11, 3, 4, 5, 6]);

/* actualStart = 4, itemCount = 0, actualDeleteCount = len - 4 */
actualStart = 4;
actualDeleteCount = len - 4;
assert.sameValue(tup.toSpliced(actualStart, actualDeleteCount), #[1, 2, 3, 4]);

/* actualStart = 4, itemCount = 1, actualDeleteCount = len - 4 */
assert.sameValue(tup.toSpliced(actualStart, actualDeleteCount, "monkeys"), #[1, 2, 3, 4, "monkeys"]);

/* actualStart = 4, itemCount = 4, actualDeleteCount = len - 4 */
assert.sameValue(tup.toSpliced(actualStart, actualDeleteCount, 0, -1, -2, -3), #[1, 2, 3, 4, 0, -1, -2, -3]);

/* actualStart = 4, itemCount = 0, actualDeleteCount < len - 4 */
actualDeleteCount = 1;
assert.sameValue(tup.toSpliced(actualStart, actualDeleteCount), #[1, 2, 3, 4, 6]);

/* actualStart = 4, itemCount = 1, actualDeleteCount < len - 4 */
assert.sameValue(tup.toSpliced(actualStart, actualDeleteCount, "monkeys"), #[1, 2, 3, 4, "monkeys", 6]);

/* actualStart = 4, itemCount = 4, actualDeleteCount < len - 4 */
assert.sameValue(tup.toSpliced(actualStart, actualDeleteCount, "p", "q", "r", "s"), #[1, 2, 3, 4, "p", "q", "r", "s", 6]);
