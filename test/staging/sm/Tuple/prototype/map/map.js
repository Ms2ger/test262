...
let f = (x, i, tup) => x + 1;
assert.sameValue(method.call(#[1,2,3,4,5,6],f), #[2,3,4,5,6,7]);
assert.sameValue(method.call(Object(#[1,2,3,4,5,6]), f), #[2,3,4,5,6,7]);
