...
assert.sameValue(method.call(#[1,#[2],3]), #[1,2,3]);
assert.sameValue(method.call(Object(#[1,#[2],3])), #[1,2,3]);
...
assert.sameValue(tup.flat("monkeys"), tup.flat(0));
assert.sameValue(tup.flat({}), tup.flat(0));
assert.sameValue(tup.flat(+0), tup.flat(0));
assert.sameValue(tup.flat(-0), tup.flat(0));
assert.sameValue(tup.flat('2'), tup.flat(2));
assert.sameValue(tup.flat(true), tup.flat(1));
assert.sameValue(tup.flat(false), tup.flat(0));
assert.sameValue(tup.flat(null), tup.flat(0));
assert.sameValue(tup.flat(NaN), tup.flat(0));
assert.sameValue(tup.flat([1,2,3]), tup.flat(0));
...
assert.sameValue(tup.flat(undefined), tup.flat(1));
assert.sameValue(tup.flat(), tup.flat(1));

/* Step 7 */
assert.sameValue(#[].flat(), #[]);
assert.sameValue(#[1].flat(), #[1]);
assert.sameValue(#[#[1,2],#[3,4]].flat(), #[1,2,3,4]);
assert.sameValue(tup.flat(0), tup);
assert.sameValue(tup.flat(1), #[1,2,3,#[4,5],6,5,6,7]);
assert.sameValue(tup.flat(2), #[1,2,3,4,5,6,5,6,7]);
assert.sameValue(tup.flat(3), tup.flat(2));
assert.sameValue(tup2.flat(0), tup2);
assert.sameValue(tup2.flat(1), #[1,2,3,#[4,#["a", "b"], 5],6,5,#[6,#[7,8,#[9,10]]],7]);
assert.sameValue(tup2.flat(2), #[1,2,3,4,#["a", "b"],5,6,5,6,#[7, 8, #[9, 10]],7]);
assert.sameValue(tup2.flat(3), #[1,2,3,4,"a","b",5,6,5,6, 7, 8, #[9, 10], 7]);
assert.sameValue(tup2.flat(4), #[1,2,3,4,"a","b",5,6,5,6, 7, 8, 9, 10, 7]);

/* FlattenIntoTuple steps: */
/* Step 3: depth can be Infinity or -Infinity */
assert.sameValue(tup2.flat(Infinity), tup2.flat(4));
assert.sameValue(tup2.flat(-Infinity), tup2.flat(0));
